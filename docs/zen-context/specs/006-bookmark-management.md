...
- 2026-04-28: Addressed PR review feedback by making form submit returns `void`, hiding bookmark mutation actions while Raycast is loading/streaming data, and applying bookmark edit/delete state changes with functional state updates.
